...
def batched(iterable, n):
    ...
    The last batch may be shorter. NOTE based on more-itertools impl, to be replaced by python 3.12
    itertools.batched impl
    """
    it = iter(iterable)
    while True:
...
def build_zero_shot_classifier(
    ...
    def _process_batch(batch_classnames):
        ...
        class_embeddings = class_embeddings.reshape(num_batch_classes, num_templates, -1).mean(
            dim=1
        )
